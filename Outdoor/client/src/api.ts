import type { GenerateResult, Itinerary, OutdoorSettings, TransportMode, TripIntent } from "./types";
...
export const api = {
  generate: (query: string, mode?: TransportMode, overrides?: Partial<TripIntent>) => request<GenerateResult>("/api/outdoor/generate", json("POST", { query, mode, overrides })),
