      ...
      <header className="mb-5 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        ...
        {pattern && (
          <button
            ...
            className="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl bg-indigo-500 px-4 py-2.5 font-semibold text-[#172027] transition-colors hover:bg-indigo-400"
          >
