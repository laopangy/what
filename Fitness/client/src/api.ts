...
export const api = {
  ...
  addSession: (data: Pick<WorkoutSession, "name" | "activityType" | "weekday" | "focus" | "targetDurationMinutes" | "targetDistanceKm" | "targetElevationM" | "breakfast" | "lunch" | "dinner" | "snack" | "activities">) => request<WorkoutSession>("/api/fitness/sessions", json("POST", data)),
  updateSession: (id: string, data: Pick<WorkoutSession, "name" | "activityType" | "weekday" | "focus" | "targetDurationMinutes" | "targetDistanceKm" | "targetElevationM" | "breakfast" | "lunch" | "dinner" | "snack" | "activities">) => request<WorkoutSession>(`/api/fitness/sessions/${id}`, json("PUT", data)),
