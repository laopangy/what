...
type ExercisePreset = Omit<Exercise, "id"> & { category: string };
const exercisePresets: ExercisePreset[] = [
  { category: "胸", name: "哑铃卧推", muscle: "胸 / 肱三头", sets: 3, reps: "8–12", restSeconds: 90, trackingType: "weight_reps" },
  { category: "胸", name: "杠铃卧推", muscle: "胸 / 肱三头", sets: 3, reps: "6–10", restSeconds: 120, trackingType: "weight_reps" },
  { category: "胸", name: "上斜哑铃卧推", muscle: "上胸", sets: 3, reps: "8–12", restSeconds: 90, trackingType: "weight_reps" },
  { category: "胸", name: "蝴蝶机夹胸", muscle: "胸", sets: 3, reps: "10–15", restSeconds: 60, trackingType: "weight_reps" },
  { category: "胸", name: "俯卧撑", muscle: "胸 / 肱三头", sets: 3, reps: "8–20", restSeconds: 60, trackingType: "reps" },
  { category: "背", name: "高位下拉", muscle: "背阔肌", sets: 3, reps: "8–12", restSeconds: 90, trackingType: "weight_reps" },
  { category: "背", name: "坐姿划船", muscle: "中背 / 肱二头", sets: 3, reps: "8–12", restSeconds: 90, trackingType: "weight_reps" },
  { category: "背", name: "单臂哑铃划船", muscle: "背", sets: 3, reps: "每侧8–12次", restSeconds: 90, trackingType: "weight_reps" },
  { category: "背", name: "辅助引体向上", muscle: "背 / 肱二头", sets: 3, reps: "6–10", restSeconds: 90, trackingType: "reps" },
  { category: "肩", name: "坐姿哑铃肩推", muscle: "肩", sets: 3, reps: "8–12", restSeconds: 90, trackingType: "weight_reps" },
  { category: "肩", name: "哑铃侧平举", muscle: "肩", sets: 3, reps: "12–15", restSeconds: 60, trackingType: "weight_reps" },
  { category: "腿", name: "杠铃深蹲", muscle: "腿 / 臀", sets: 3, reps: "6–10", restSeconds: 120, trackingType: "weight_reps" },
  { category: "腿", name: "腿举", muscle: "腿", sets: 3, reps: "10–15", restSeconds: 90, trackingType: "weight_reps" },
  { category: "腿", name: "罗马尼亚硬拉", muscle: "臀腿", sets: 3, reps: "8–12", restSeconds: 120, trackingType: "weight_reps" },
  { category: "手臂", name: "哑铃弯举", muscle: "肱二头", sets: 3, reps: "10–15", restSeconds: 60, trackingType: "weight_reps" },
  { category: "手臂", name: "绳索下压", muscle: "肱三头", sets: 3, reps: "10–15", restSeconds: 60, trackingType: "weight_reps" },
  { category: "核心", name: "平板支撑", muscle: "核心", sets: 3, reps: "45秒", restSeconds: 60, trackingType: "duration" },
  { category: "核心", name: "卷腹", muscle: "核心", sets: 3, reps: "12–20", restSeconds: 60, trackingType: "reps" },
  { category: "有氧", name: "跳绳", muscle: "有氧", sets: 3, reps: "60秒", restSeconds: 60, trackingType: "duration" },
];
const exerciseCategories = [...new Set(exercisePresets.map((exercise) => exercise.category))];
...
function Training({ data, refresh, notify }: { data: FitnessState; refresh: () => Promise<void>; notify: (message: string) => void }) {
  ...
  const applyExercisePreset = (id: string, name: string) => {
    const preset = exercisePresets.find((exercise) => exercise.name === name);
    if (preset) updateExercise(id, { name: preset.name, muscle: preset.muscle, sets: preset.sets, reps: preset.reps, restSeconds: preset.restSeconds, trackingType: preset.trackingType });
  };
